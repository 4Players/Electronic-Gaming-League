...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<table border="0" cellpadding="3" cellspacing="1" width="100%">
	 {section name=cup loop=$attach_cupsplayed}
	 	<tr bgcolor="{#clr_content#}">
	 		<td width="80%"><A href="{$url_file}page={$ATTACHED_MODULE_ID}:info&cup_id={$attach_cupsplayed[cup]->id}"><b>{$attach_cupsplayed[cup]->name|strip_tags|stripslashes}</b></a></td>
	 		<td></td>
	 	</tr>
	 {/section}
	 </table>
 ...
 {if sizeof($attach_cupsentered) > 0}
	 ...
	 {section name=cup loop=$attach_cupsentered}
	 	<tr bgcolor="{#clr_content#}">
	 		<td><A href="{$url_file}page={$ATTACHED_MODULE_ID}:info&cup_id={$attach_cupsentered[cup]->id}"><b>{$attach_cupsentered[cup]->name|strip_tags|stripslashes}</b></a></td>
