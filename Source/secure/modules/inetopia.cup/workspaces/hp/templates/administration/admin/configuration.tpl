 	 ...
 	 <table cellpadding="0" cellspacing="2" width="100%" bgcolor="#C0C0C0">
 	  <tr><td bgcolor="#FFFFFF">
			<table border="0" cellpadding="10" cellspacing="1" width="100%">
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	<td><b>Kategorie:</b></td>
				<td><select style="width:400;" name="cat_id" class="egl_select">
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	...
			 	<td>
			 		<select style="width:250;" name="max_participants" class="egl_select">
				 		{section name=num_players loop= 10 }
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	...
			 	<td><textarea class="egl_text" name="map_pool" style="width:250;" cols="40">{$cup->map_pool|strip_tags|stripslashes}</textarea> </td>
			 </tr>
			 <tr bgcolor="{#clr_content#}">
			 	<td valign="top"><b>Beschreibung:</b></td>
			 	<td><textarea style="width:100%;"name="description" class="egl_text" rows="10" cols="80">{$cup->description|strip_tags|stripslashes}</textarea></td>
			 </tr>
			 <tr bgcolor="{#clr_content#}">
			 	<td colspan="2" align="right">{include file="buttons/bt_universal.tpl"  caption="abschicken" color=$GLOBAL_COLOR link="javascript:document.cup_form.submit();"}</td>
			 </tr>
			</table>
