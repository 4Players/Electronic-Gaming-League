		   ...
		   {if $index < sizeof($cups) }
		   		<td align="center"> 
		   			<table cellpadding="1" cellspacing="0"><tr><td>
		   				<A href="{$url_file}page={$CURRENT_MODULE_ID}:administration.admin.overview&cup_id={$cups[$index]->id}"><img onmousemove="javascript:detailwindow_showdiv('dwindow{$cups[$index]->id}');" onmouseout="javascript:detailwindow_hidediv('dwindow{$cups[$index]->id}');" border="0" src="images/modules/inetopia_cup/cup_icon.gif" /></a>
					</td></tr></table>		
