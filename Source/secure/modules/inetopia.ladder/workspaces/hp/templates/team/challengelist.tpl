...
<table align="center">
	<tr>
	{if $_get.dir=="out"}
		<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption=$LNG_MODULE.c9080 link="`$url_file`page=`$url_page`&team_id=`$_get.team_id`&dir=in"}</td>
		<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption=$LNG_MODULE.c9082 selected="true" link="`$url_file`page=`$url_page`&team_id=`$_get.team_id`&dir=out"}</td>
	{else}
		<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption=$LNG_MODULE.c9080 selected="true" link="`$url_file`page=`$url_page`&team_id=`$_get.team_id`&dir=in"}</td>
		<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption=$LNG_MODULE.c9082 link="`$url_file`page=`$url_page`&team_id=`$_get.team_id`&dir=out"}</td>
	{/if}
	</tr>
</table>
		...
		<td>
			...
			<table cellpadding="5" width="100%">
			 <tr>
				...
				<A href="{$url_file}page=team.info&team_id={$out_challenges[outc]->opponent_id}">{$out_challenges[outc]->opponent_name}</a>
				</td>				
			 ...
			 <tr>
			 	<td colspan="4">
			 		...
			 		<tr>
			 			<!--#<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="annehmen" link="`$url_file`page=`$CURRENT_MODULE_ID`:team.accept&challenge_id=`$out_challenges[outc]->id`"}</td>#-->
			 			<!--#<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="ablehnen" link="`$url_file`page=`$CURRENT_MODULE_ID`:team.deny&challenge_id=`$out_challenges[outc]->id`"}</td>#-->
			 			...
			 			<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="`$LNG_BASIC.c1203`.." link="`$url_file`page=`$CURRENT_MODULE_ID`:team.challengedetails&challenge_id=`$out_challenges[outc]->id`&team_id=`$out_challenges[outc]->challenger_id`"}</td>
			 		</tr>
			 		</table>
			 		<br/>
		...
		<td>
			...
			<table cellpadding="5" width="100%">
			 <tr>
				...
				<A href="{$url_file}page=team.info&team_id={$in_challenges[inc]->challenger_id}">{$in_challenges[inc]->challenger_name}</a>
				</td>				
			 ...
			 <tr>
			 	<td colspan="4">
			 		<table cellpadding="5" align="right">
			 		<tr>
			 			<!--#<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="annehmen" link="`$url_file`page=`$CURRENT_MODULE_ID`:team.accept&challenge_id=`$in_challenges[inc]->id`"}</td>#-->
			 			<!--#<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="ablehnen" link="`$url_file`page=`$CURRENT_MODULE_ID`:team.deny&challenge_id=`$in_challenges[inc]->id`"}</td>#-->
			 			...
			 			<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="`$LNG_BASIC.c1203`.." link="`$url_file`page=`$CURRENT_MODULE_ID`:team.challengedetails&challenge_id=`$in_challenges[inc]->id`&team_id=`$in_challenges[inc]->opponent_id`"}</td>
			 		</tr>
			 		</table>
			 		<br/>
