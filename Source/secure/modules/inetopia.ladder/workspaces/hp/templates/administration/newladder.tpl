...
<tr>
	...
	<td>{include file="buttons/bt_universal.tpl" caption="Ladderübersicht" 	color=$GLOBAL_COLOR link="`$url_file`page=`$CURRENT_MODULE_ID`:administration.gameladders&game_id=`$game->id`"}</td>
	 	  ...
	 	  <tr><td bgcolor="#FFFFFF">
				<table border="0" cellpadding="10" cellspacing="1" width="100%">
				 ...
				 <tr bgcolor="{#clr_content#}">
			 	 ...
			 	 <tr bgcolor="{#clr_content#}">
				 	<td colspan="2" align="right">{include file="buttons/bt_universal.tpl"  caption="abschicken" color=$GLOBAL_COLOR link="javascript:document.ladder_form.submit();"}</td>
				 </tr>
				</table>
