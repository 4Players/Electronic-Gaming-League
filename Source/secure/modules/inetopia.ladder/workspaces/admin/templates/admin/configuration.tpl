...
<script language="javascript">
	...
	function show_mapcollection(url){
		var __mapcollection_id = document.forms['ladder_form'].mapcollection_id.options[ document.forms['ladder_form'].mapcollection_id.selectedIndex ].value;
		if( __mapcollection_id == -1 )document.location.href = url+"page=cms.map_collections.overview";
		else document.location.href = url+"page=cms.map_collections.admin&collection_id="+__mapcollection_id;
	}
 	 ...
 	 <table cellpadding="0" cellspacing="2" width="100%" bgcolor="#C0C0C0">
 	  <tr><td bgcolor="#FFFFFF">
			<table border="0" cellpadding="10" cellspacing="1" width="100%">
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	...
			 	<td><select name="country_id" class="egl_select" style="width:400px;">
			 			{section name=c loop=$countries}
			 				<option {if $ladder->country_id == $countries[c]->id}selected{/if} value="{$countries[c]->id}">{$countries[c]->name}</option>
			 			{/section}
			 		</select>
			 	</td>
			 </tr>
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	<td width="200"><b>Fast-Challenger:</b></td>
			 	<td>
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	<td width="200"><b>Ladderstart:</b></td>
			 	<td>
			 ...
			 <tr bgcolor="{#clr_content#}">
			 	<td width="200"><b>Fordersperre:</b></td>
			 	<td>
			 		<select style="width:135;"class="egl_select" name="challenge_locked">
			 			<option value="0">Deaktiviert</option>
			 			<option value="1" {if $ladder->challenge_locked}selected{/if} >Aktiviert</option>
			 		</select>
			 	</td>
			 </tr>
			 <tr bgcolor="{#clr_content#}">
