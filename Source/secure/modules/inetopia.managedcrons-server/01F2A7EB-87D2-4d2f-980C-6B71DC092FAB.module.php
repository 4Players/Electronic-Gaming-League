...
define( "MODULEID_MANAGEDCRONS_SERVER",	"01F2A7EB-87D2-4d2f-980C-6B71DC092FAB" );

egl_require( dirname(__FILE__) . EGL_DIRSEP.'classes'.EGL_DIRSEP.	'ManagedCronsServer.class.php' );
egl_require( dirname(__FILE__) . EGL_DIRSEP.'classes'.EGL_DIRSEP.	'ManagedCronsServerTimer.class.php' );


class MODULE_01F2A7EB87D24d2f980C6B71DC092FAB extends Module
{
	...
	function ProcessMessage( $event, &$data, $wparam=NULL, $lparam=NULL )
	{
		switch( $event )
		{
			...
			case 'info':
			{
				...
				{
					$data->ID 				= MODULEID_MANAGEDCRONS_SERVER;
					$data->sName 			= "ManagedCrons-Server";
					$data->sVersion 		= "0.2";
