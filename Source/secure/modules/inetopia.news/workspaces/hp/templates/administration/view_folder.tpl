			    ...
			    <td align="center">
					<table cellpadding="10">
					 <tr>
						...
						<td align="center">
							<A title="{$root_tree->aNodes[$index]->oProperties->name}" href="{$url_file}page={$url_page}&cat_id={$root_tree->aNodes[$index]->oProperties->id}"><img src="images/hpadmin/folder.gif" border="0"/></a><br/>
