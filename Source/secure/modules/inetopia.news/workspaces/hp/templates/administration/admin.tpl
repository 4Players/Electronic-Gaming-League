...
<table cellpadding="0" cellspacing="1" bgcolor="#A80000" width="200">
 <tr><td>
	<table with="200" cellpadding="10" cellspacing="0" width="100%">
	 <tr bgcolor="{#clr_content#}">
	 	<td><input type="checkbox" class="egl_text" value="yes" name="delete_accepted"/> <b>Löschen bestätigen</b> </td>
	 </tr>
	 <tr bgcolor="{#clr_content#}">
	 	<td>{include file="buttons/bt_universal.tpl" color=$GLOBAL_COLOR caption="löschen" link="javascript:document.news_delete.submit();"}</td>
	 </tr>
	</table>
