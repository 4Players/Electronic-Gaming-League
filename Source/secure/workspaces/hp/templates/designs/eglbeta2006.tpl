<HTML>
<head>
	<title>EGL v{$EGL_CURRENT_VERSION} &copy;2006 by Inetopia.de - Professional E-Sport Solutions</title>
...
<table border="0" cellpadding="0" cellspacing="0" height="1200" width="900">
 <tr>
 		...
 		<table border="0" cellpadding="0" cellspacing="0">
 		 <tr>
 		 	...
 		 	<td width="100%">
				 ...
				 <td> <A href='{$url_file}page=home' class="topheader_menu"><b>EGL.STARTSEITE</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=member.memberlist' class="topheader_menu"><b>MITGLIEDER</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=clan.clanlist' class="topheader_menu"><b>CLANS</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=team.teamlist' class="topheader_menu"><b>TEAMS</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=support' class="topheader_menu"><b>SUPPORT</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=partner' class="topheader_menu"><b>PARTNER</b></A></td>
				 <td> <font color="#FFFFFF">&nbsp;|&nbsp;</font></td>
				 <td> <A href='{$url_file}page=imprint' class="topheader_menu"><b>IMPRESSUM</b></A></td>
			 	  </td></tr>
			 	 </table>
			</td>
		 </tr>
 ...
 <tr>
 	<td colspan="3" height="1%" bgcolor="#D4D7d3">
 		<table border="0" cellspacing="0" cellpadding="0" width="100%" background="images/eglbeta/content/design/{$GLOBAL_COLOR}/header.jpg" style="background-repeat:no-repeat;">
 		 <tr> <td><img src="images/spacer.gif" width="50" height="133"/></td> </tr>
 		 <!--<tr> <td></td> </tr>-->
 		</table>
 	</td>
 </tr>
	 		 ...
	 		 <tr>
	 		 	...
	 		 	{if $smarty.cookies.member.game_id > 0}
					<table border="0" cellpadding="5" cellspacing="0">
					 <td><A href='{$url_file}page=gameview.summary' class="header_menu"><b>ÜBERSICHT</b></A></td>
					 <td>&nbsp;&nbsp;</td>
					 <td><div id="m3" style="position:relative;z-index:1;"><A onmouseover="stopTime(); _div_show('d3');" onmouseout="startTime();" href='{$url_file}page=gameview.leagues' class="header_menu"><b>LIGEN</b> <img border="0" src="images/eglbeta/menudown.gif"/></A></div></td>
					 <td>&nbsp;&nbsp;</td>
					 <td><A href="{$url_file}page={module_getid cname='INETOPIA_POLLS'}:overview&game_id={$smarty.cookies.member.game_id}" class="header_menu"><b>UMFRAGEN</b></A></td>
					 <td>&nbsp;&nbsp;</td>
					 <td><A href='{$url_file}page=forums.overview&game_id={$smarty.cookies.member.game_id}' class="header_menu"><b>FORUM</b></A></td>
				 	  </td></tr>
				 	 </table>
				 {else}
				 	&nbsp;
		 		 	 		 ...
		 		 	 		 <tr onmouseover="stopTime(); _div_show('d2');" onmouseout="startTime();">
		 		 	 		 	...
		 		 	 		 	<td background="images/eglbeta/chosed_game_middle.gif">
		 		 	 		 	 	 <table width="100%" cellpadding="0" cellspacing="0">
						   		 	   <tr>
							   		 	<td><A class="chosegame_a" href="{$url_file}page=member.center"><b>{$member->email}</b></a></td>
							   		  </tr>
							   		</table>
		 		 	 		 	</td>
		 		 	 		 	<td width="1%"><img src="images/eglbeta/chosed_game_right.gif"/></td>
