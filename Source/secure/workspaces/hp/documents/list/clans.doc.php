<?php
	...
	{
		# create results
		$aResults = $gl_oVars->cDBInterface->FetchArrayObject($gl_oVars->cDBInterface->Query( $gl_oVars->cDBInterface->CreateSelectQuery( $GLOBALS['g_egltb_clan_accounts'], $aSearchObj, true, NULL, ' LIMIT 0,50', false, 'INSTR($VAR,\'$VALUE\')' ) ));
