<?php
	...
	if( $_GET['a']	== "mail:send" )
	{
		...
		else if( $_POST['mail_type'] == "email" )
		{
			...
			{
				$gl_oVars->cTpl->assign( 'msg_type', 	'error' );
				$gl_oVars->cTpl->assign( 'msg_text', 	'Die eMail konnt nicht gesendet werden. Sollte dieser Fehler erneut auftreten, wenden Sie sich bitte an die zuständigen Administratoren.' );
			}
	...
	if( $bMemberBanned )$gl_oVars->cTpl->assign( "MEMBER_BANNED", true );
